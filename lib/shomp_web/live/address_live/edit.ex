defmodule ShompWeb.AddressLive.Edit do
    ...
    <Layouts.app flash={@flash} current_scope={@current_scope}>
      <div class="mx-auto max-w-2xl">
        <div class="mb-8">
          <.header>
            Edit Address
            <:subtitle>Update your <%= @address.type %> address</:subtitle>
          </.header>
        </div>
            ...
            <.form for={@form} phx-submit="save" class="space-y-6">
              ...
              <div class="form-control">
                <.input 
                  ...
                  type="checkbox" 
                  label={"Set as default " <> @address.type <> " address"}
  ...
  def mount(%{"id" => id}, _session, socket) do
    ...
    if address.user_id != user.id do
      raise Phoenix.Router.NoRouteError, "Address not found"
    end
